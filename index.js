...
//Wordbank
var wordList = ["netflix","cocacola","outlander","friends","television","baywatch","developer","oracle","moana","storks","matrix","trainwreck","lovesick"];
...
function checkIfUserWon() {
	...
	if (guessesRemaining === 0) {
		...
		console.log(gameTextColor("The answer is: " + randomWord));
	...
	//else if the number of slots/underscores that are filled in with a letter equals the number of letters in the word, the user won.
		...
		console.log(gameTextColor("====================================================================="));
		console.log(correct("YOU WON! YOU'RE A WINNER!!"));
